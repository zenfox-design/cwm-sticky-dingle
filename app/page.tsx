...
<section className="hero" id="top"><Image unoptimized className="hero-image" src="/images/cwm-sticky-dingle-glamping-valley.webp" alt="Cwm Sticky Dingle's wooded glamping valley near Govilon" fill priority sizes="100vw"/><div className="hero-shade"/><div className="contours"/><Image unoptimized className="hero-emblem" src="/images/cwm-sticky-dingle-emblem.webp" alt="Cwm Sticky Dingle Glamping emblem" width={250} height={250}/><div className="hero-copy"><p className="kicker light">Off-grid glamping · Govilon · South Wales</p><h1>Stay wild.<br/>Gather differently.</h1><p className="hero-intro">A secluded yurt, a vintage bus and a woodland roundhouse near Abergavenny and Bannau Brycheiniog.</p><div className="hero-actions"><a className="button button-light" href="#stay">Find your stay</a><a className="text-link" href="#gather">Host something special <span>↗</span></a></div></div><div className="hero-location"><span className="pulse"/><span>Between the Blorenge<br/>&amp; Gilwern Hill</span></div><a className="scroll" href="#intro"><span>Discover</span><span>↓</span></a></section>
